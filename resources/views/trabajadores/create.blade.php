  <div class="container mt-5">
      <ul class="nav nav-tabs custom-tabs" id="personalTab" role="tablist">
          ...
          <li class="nav-item">
              <a class="nav-link" id="regimenpensionario-tab" data-toggle="tab" href="#regimenpensionario"
                  role="tab" aria-controls="regimenpensionario" aria-selected="false">Regimen Pensionario</a>
          </li>
          <li class="nav-item">
      ...
      <form id="personalForm" method="POST" action="{{ route('personals.store') }} ">
          ...
          <div class="tab-content">
              ...
              <div class="tab-pane fade" id="regimenpensionario" role="tabpanel"
                  aria-labelledby="regimenpensionario-tab">
              ...
              <div class="tab-pane fade" id="jornadalaboral" role="tabpanel" aria-labelledby="jornadalaboral-tab">
                  @include('trabajadores.jornadalaboral')
              </div>
              <div class="tab-pane fade" id="diassubcidiados" role="tabpanel" aria-labelledby="diassubcidiados-tab">
                  @include('trabajadores.diassubcidiados')
              </div>
              <div class="tab-pane fade" id="diasnosubcidiados" role="tabpanel"
                  aria-labelledby="diasnosubcidiados-tab">
                  @include('trabajadores.diasnosubcidiados')
              </div>
              <div class="tab-pane fade" id="remuneracion" role="tabpanel" aria-labelledby="remuneracion-tab">
                  @include('trabajadores.remuneracion')
              </div>
          </div>
