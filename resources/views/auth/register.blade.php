        ...
        <div class="col-md-6">
            <div class="card">
                <div class="col-md-auto" style="
                    ...
                    margin-top: 5px;
                    margin-bottom: 20px;">
                        <img src="{{ asset('/images/tacna.png') }} " alt=""
                            style=
                    "height: 100  px;
                    width: 200px;
                    ">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" style="background-color: #ff3e1d;color: #fff;border-color: #ff3e1d; box-shadow: 0 .125rem .25rem 0 rgba(255, 62, 29, .4);">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
