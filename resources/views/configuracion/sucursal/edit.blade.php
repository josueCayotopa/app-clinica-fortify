                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="empresa_id" name="empresa_id" required>
                                        @foreach ($empresas as $id => $nombre_comercial)
                                            <option value="{{ $id }}"
                                                {{ old('empresa_id', $sucursale->empresa_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $nombre_comercial }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Correo Electrónico"
                                        name="email" value="{{ old('email', $sucursale->email) }}" required>
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" id="fecha_inicio"
                                        ...
                                        value="{{ old('fecha_inicio', $sucursale->fecha_inicio ?? '') }}" required
                                        autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="departamento_id" name="departamento_id" required>
                                        ...
                                        @foreach ($departamentos as $id => $descripcion)
                                            <option value="{{ $id }}"
                                                {{ old('departamento_id', $sucursale->departamento_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="provincia_id" name="provincia_id" required>
                                        ...
                                        @foreach ($provincias as $id => $descripcion)
                                            <option value="{{ $id }}"
                                                {{ old('provincia_id', $sucursale->provincia_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="distrito_id" name="distrito_id" required>
                                        ...
                                        @foreach ($distritos as $id => $descripcion)
                                            <option value="{{ $id }}"
                                                {{ old('distrito_id', $sucursale->distrito_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $descripcion }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="zona_id" name="zona_id" required>
                                        ...
                                        @foreach ($zonas as $id => $zona)
                                            <option value="{{ $id }}"
                                                {{ old('zona_id', $sucursale->zona_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $zona }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="via_id" name="via_id" required>
                                        ...
                                        @foreach ($vias as $id => $via)
                                            <option value="{{ $id }}"
                                                {{ old('via_id', $sucursale->via_id ?? '') == $id ? 'selected' : '' }}>
                                                {{ $via }}
                                            </option>
                                        @endforeach
                                    </select>
