                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="RUC" autocapitalize="none"maxlength="11"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Telefono Comercial" maxlength="9"
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($tipo_monedas as $id => $descripcion)
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="tipo_moneda_id"
                                            value="{{ $id }}" id="tipo_moneda_id{{ $id }}"
                                            {{ old('tipo_moneda_id') == $id ? 'checked' : '' }}>
