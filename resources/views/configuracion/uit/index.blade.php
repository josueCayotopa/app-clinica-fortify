...
@section('home')
                                        ...
                                        @foreach ($uits as $uit)
                                            <tr class="el-table__row">
                                                ...
                                                <td class="el-table_1_column_7 is-right el-table__cell" rowspan="1"
                                                    colspan="1">
                                                    <div class="cell">
                                                        <a href=" {{ route('uits.edit', $uit->ano_proceso) }}"
                                                            aria-disabled="false"
                                                    ...
                                                    <div class="cell">
                                                        ...
                                                        <form action="{{ route('uits.destroy', $uit->ano_proceso) }}"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
            ...
            @include('configuracion.uit.create') <!-- Incluir el formulario de crear elemento -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Manejar el cierre del modal desde el botón "Cancelar"
