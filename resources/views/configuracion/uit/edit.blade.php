    ...
    <div class="row">
        <div class="col-md-12 offset-md-0">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('uits.update', $uit->ano_proceso) }}" method="POST"
                                ...
                                <div class="el-input">
                                    <div class="el-input__wrapper" tabindex="-1">
                                        <input class="el-input__inner" type="number" autocomplete="off" tabindex="0"
                                            id="ano_proceso" name="ano_proceso"
                                            value="{{ old('ano_proceso', $uit->ano_proceso) }}" spellcheck="false"
                                ...
                                <div class="el-input">
                                    <div class="el-input__wrapper" tabindex="-1">
                                        <input class="el-input__inner" type="number" autocomplete="off" tabindex="0"
                                            ...
                                            value="{{ old('num_uit_deducible', $uit->num_uit_deducible) }}"
                            ...
                            <tbody>
                                @for ($i = 1; $i <= 12; $i++)
                                    ...
                                    <tr>
                                        <td>{{ $mesFormateado }}</td>
                                        <td>
                                            <input type="number" name="meses[{{ $mesFormateado }}]"
