        ...
        <div class="card-body">
            <form action="{{ route('tipo_trabajador_ipsses.update', $tipoTrabajadorIpss->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="COD_TRABAJ_IPSS" class="form-control"
                        value="{{ $tipoTrabajadorIpss->COD_TRABAJ_IPSS }}" required maxlength="2">
                </div>
                <div class="form-group">
                    <label for="DES_COD_TRABAJ_IPSS">Descripción</label>
                    <input type="text" name="DES_COD_TRABAJ_IPSS" class="form-control"
                        value="{{ $tipoTrabajadorIpss->DES_COD_TRABAJ_IPSS }}" maxlength="50">
                </div>
