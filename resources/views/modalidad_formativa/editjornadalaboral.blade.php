        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese las horas trabajadas"
                    name="horas_trabajadas" value="{{ old('horas_trabajadas', $modalidadFormativa->horas_trabajadas) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese los minutos trabajados"
                    ...
                    value="{{ old('minutos_trabajados', $modalidadFormativa->minutos_trabajados) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese las horas de sobretiempo"
                    name="horas_sobretiempo"
                    value="{{ old('horas_sobretiempo', $modalidadFormativa->horas_sobretiempo) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese los minutos de sobretiempo"
                    ...
                    value="{{ old('minutos_sobretiempo', $modalidadFormativa->minutos_sobretiempo) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese una descripción" name="descripcion"
                    value="{{ old('descripcion', $modalidadFormativa->descripcion) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese el número de días a la semana"
                    name="numero_dias_semana"
                    value="{{ old('numero_dias_semana', $modalidadFormativa->numero_dias_semana) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="time" class="form-control" name="hora_ingreso"
                    value="{{ old('hora_ingreso', $modalidadFormativa->hora_ingreso) }}">
        ...
        <div class="col-md-6 mb-1">
            <div class="form-group">
                ...
                <input type="time" class="form-control" name="hora_salida"
                    value="{{ old('hora_salida', $modalidadFormativa->hora_salida) }}">
