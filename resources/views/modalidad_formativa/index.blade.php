...
@section('main')
                        ...
                        <div class="el-scrollbar__wrap el-scrollbar__wrap--hidden-default">
                            <div class="el-scrollbar__view" style="display: inline-block; vertical-align: middle;">
                                <table class="el-table__body" cellspacing="0" cellpadding="0" border="0"
                                    ...
                                    <tbody tabindex="-1">
                                        @foreach ($datosPersonales as $modalidad_formativa)
                                            <tr class="el-table__row">
                                                <td class="el-table_1_column_1 el-table__cell" rowspan="1"
                                                    colspan="1">
                                                    <div class="cell">
                                                        {{ $modalidad_formativa->nombres }}
                                                ...
                                                <td class="el-table_1_column_2 el-table__cell" rowspan="1"
                                                    colspan="1">
                                                    <div class="cell">
                                                        {{ $modalidad_formativa->apellido_paterno }}
                                                ...
                                                <td class="el-table_1_column_3 el-table__cell" rowspan="1"
                                                    colspan="1">
                                                    <div class="cell">
                                                        {{ $modalidad_formativa->numero_documento }}
                                                ...
                                                <td>
                                                    ...
                                                    @if ($modalidad_formativa->modalidad_formativa)
                                                        @if ($modalidad_formativa->modalidad_formativa->periodoLaboral)
                                                            @if ($modalidad_formativa->modalidad_formativa->periodoLaboral->estado)
                                                                Activo
                                                            @else
                                                                Inactivo
                                                            @endif
                                                ...
                                                <td class="el-table_1_column_7 is-right el-table__cell" rowspan="1"
                                                    colspan="1">
                                                    <div class="cell"
                                                        style="display: flex; justify-content: flex-end; gap: 5px;">
                                                        <!-- Botón de edición -->
                                                        <a href="{{ route('modalidad_formativa.edit', $modalidad_formativa->id) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('modalidad_formativa.destroy', $modalidad_formativa->id) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('¿Seguro de desactivar el periodo laboral?')">
                                                            @csrf
                                                            @method('DELETE')
    ...
    <script>
        document.getElementById('new-button').addEventListener('click', function() {
            window.location.href = '{{ route('modalidad_formativa.create') }}';
        });
    </script>
