...
(function () {
    ...
    //       ))
    //   }
    //   window.templateCustomizer ? (o && o.addEventListener("click", (function() {
    //       window.Helpers.isLightStyle() ? window.templateCustomizer.setStyle("dark") : window.templateCustomizer.setStyle("light")
    //   }
    //   )),
    //   window.Helpers.isLightStyle() ? (o && (o.querySelector("i").classList.add("bx-moon"),
    //   new bootstrap.Tooltip(o,{
    //       title: "Dark mode",
    //       fallbackPlacements: ["bottom"]
    //   })),
    //   s("light")) : (o && (o.querySelector("i").classList.add("bx-sun"),
    //   new bootstrap.Tooltip(o,{
    //       title: "Light mode",
    //       fallbackPlacements: ["bottom"]
    //   })),
    //   s("dark"))) : o.parentElement.remove();
